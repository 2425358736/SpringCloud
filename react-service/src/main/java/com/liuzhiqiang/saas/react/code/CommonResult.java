package com.liuzhiqiang.saas.react.code;
...
import com.liuzhiqiang.saas.react.enums.ResultEnum;
...
public class CommonResult<T> implements Serializable {
     ...
     * @return
     */
    public static <T> CommonResult<T> errorReturn(ResultEnum resultEnum) {
        CommonResult<T> result = new CommonResult<T>();
        result.setSuccess(false);
        result.setCode(resultEnum.code());
        result.setMessage(resultEnum.msg());
